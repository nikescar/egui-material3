...
impl LayoutGridWindow {
    ...
    fn render_controls(&mut self, ui: &mut Ui) {
        ...
        ui.horizontal(|ui| {
            ui.add(MaterialCheckbox::new(
                &mut self.show_grid_tiles,
                "Show Grid Tiles",
            ));
            ui.add(MaterialCheckbox::new(
                &mut self.show_elevation_demo,
                "Show Elevation Demo",
            ));
        });
    ...
    fn render_grid_tile_gallery(&mut self, ui: &mut Ui) {
        ...
        ui.label(
            "GridTile components with headers and footers for image galleries and card grids.",
        );
        ui.add_space(20.0);
                    ...
                    GridTile::new(|ui| {
                        ui.add(
                            MaterialCard2::filled()
                                .min_size(egui::Vec2::new(0.0, 200.0))
                                .content(|ui| {
                    ...
                    GridTile::new(|ui| {
                        ui.add(
                            MaterialCard2::elevated()
                                .min_size(egui::Vec2::new(0.0, 250.0))
                                .content(|ui| {
                                    ui.vertical_centered(|ui| {
                                        ui.add_space(100.0);
                                        ui.heading("📱");
                    ...
                    GridTile::new(|ui| {
                        ui.add(
                            MaterialCard2::outlined()
                                .min_size(egui::Vec2::new(0.0, 180.0))
                                .content(|ui| {
                                    ui.vertical_centered(|ui| {
                                        ui.add_space(70.0);
                                        ui.heading("🎨");
    ...
    fn render_elevation_demo(&mut self, ui: &mut Ui) {
        ...
        ui.label(
            "Demonstrating Material Design elevation levels with surface tint and shadow effects.",
        );
        ui.add_space(20.0);
        ...
        let tint_grid = elevations
            .iter()
            .fold(tint_grid, |grid, (level, elevation, percent)| {
                let level = *level;
        ...
        let shadow_grid =
            elevations
                .iter()
                .fold(shadow_grid, |grid, (level, elevation, percent)| {
                    let level = *level;
                    let elevation = *elevation;
                    let percent = *percent;
                    grid.cell(2, move |ui| {
